"""
Django settings for fysio_fitness project.
...
ALLOWED_HOSTS = ['fysio-fitness.herokuapp.com', 'fysiofitness.nu']
...
ROOT_URLCONF = 'fysio_fitness.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # requied by allauth
...
WSGI_APPLICATION = 'fysio_fitness.wsgi.application'
